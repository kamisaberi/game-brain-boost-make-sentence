...
import com.parsveda.brainboost.sentences.model.GameType;
...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnPlaySentence = (Button) findViewById(R.id.btnPlayNormal);
        btnPlaySentence.setTypeface(Globals.ReckonerFace, Typeface.BOLD);


        btnPlaySentence.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Globals.currentStage.setPlayType(GamePlayType.SUDDEN_DEATH);
                Globals.currentStage.setType(GameType.MAKE_SENTENCES);
        ...
        Button btnPlayQA = (Button) findViewById(R.id.btnPlayQA);
        btnPlayQA.setTypeface(Globals.ReckonerFace, Typeface.BOLD);

        btnPlayQA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Globals.currentStage.setPlayType(GamePlayType.SUDDEN_DEATH);
                Globals.currentStage.setType(GameType.QUESTION_ANSWER);
                Globals.currentStage.setTouchOrderType(StageTouchOrderType.NORMAL);
