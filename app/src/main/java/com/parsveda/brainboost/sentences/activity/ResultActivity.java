...
//        }
        ...
        btnRetry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Globals.currentStage.getType() == GameType.MAKE_SENTENCES) {
                    Intent intent = new Intent(ResultActivity.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                } else if (Globals.currentStage.getType() == GameType.QUESTION_ANSWER) {
                    Intent intent = new Intent(ResultActivity.this, QAActivity.class);
                    startActivity(intent);
                    finish();
                }
            }
